...
*************************************************************************************/
static void LabelPropagation(std::vector<std::vector<std::pair<int, double> > > listaArestas, std::vector <TSol> &Pop, std::vector<int> &label);
/************************************************************************************
 Method: PROMISINGLP
...
// apply clustering method
    LabelPropagation(listaArestas, Pop, label);
